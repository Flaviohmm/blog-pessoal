...
SECRET_KEY = 'django-insecure-1nre6tgk6xuok)vgp6^y2eab=^&w9tzdj%&=nktt+7qu*4rt02'
...
# Media files (imagens dos posts, featured_image)
MEDIA_URL = '/media/'
...
# Para upload de imagens no CKEditor funcionar
CKEDITOR5_UPLOADS = {
    'default': {
        'upload_url': '/ckeditor5/image_upload/',  # crie uma view se precisar custom
    }
}